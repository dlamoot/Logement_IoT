...
CREATE TABLE Logement (
    ...
    numero_telephone TEXT, -- Téléphone du logement
...
CREATE TABLE Capteur_Actionneur (
    ...
    port_communication TEXT,                       -- Port de communication avec le serveur
    date_insertion TIMESTAMP DEFAULT CURRENT_TIMESTAMP,  -- Date d'insertion automatique
...
VALUES ('4 Place Jussieu', '0768997510', '192.168.1.1');

-- Insertion de quatre pièces dans ce logement
INSERT INTO Piece (id_logement, nom, x, y, z) VALUES (1, 'Salon', 0, 0, 0);
INSERT INTO Piece (id_logement, nom, x, y, z) VALUES (1, 'Cuisine', 1, 0, 0);
INSERT INTO Piece (id_logement, nom, x, y, z) VALUES (1, 'Chambre', 0, 1, 0);
INSERT INTO Piece (id_logement, nom, x, y, z) VALUES (1, 'Salle de Bain', 0, 0, 1);
...
INSERT INTO Capteur_Actionneur (id_piece, id_type, reference_commerciale, port_communication)  VALUES (1, 1, 'DHT11', 'COM1');  -- Le type 1 correspond à un capteur de température

-- Actionneur dans la Chambre (par exemple, un actionneur de lumière)
INSERT INTO Capteur_Actionneur (id_piece, id_type, reference_commerciale, port_communication)  VALUES (3, 3, 'LIGHT', 'COM3');  -- Le type 3 correspond à un actionneur de lumière
...
VALUES (1, 'Électricité', '2024-10-01', 120.50, 350.0);  -- Montant de 120.50 € pour 350 kWh
